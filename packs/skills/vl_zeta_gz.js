...
export default {
    ...
    t: {
        name: "固铸",
        info: `一名角色的回合结束时，若本回合有四种花色的牌进入过${get.poptip("center")}，你可以分配于弃牌堆的其中一种花色的牌。若你将这些牌全部分配给其他角色，你重置${get.poptip("vl_zeta_fg")}并令一名角色执行一个额外的出牌阶段。`,
        taici: ["铸好的东西，就不会白白散掉。", "归位，或者再铸一次。"],
    },
};
