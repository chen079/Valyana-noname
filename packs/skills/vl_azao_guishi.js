...
export default {
	...
	t: {
		name: "归誓",
		info: `限定技，当你进入濒死状态时，你可以将体力值回复至1点。若如此做，将${get.poptip("vl_azao_huxi")}中的“置于你的武将牌上”改为“放入手牌”。然后你获得所有的“护”，并获得${get.poptip("vl_azao_qihui")}。本回合结束时，你立刻执行一个额外的回合。`,
        taici: ['魂归幽径，听我号令。', '死者低语，生者让路。'],
    },
};
