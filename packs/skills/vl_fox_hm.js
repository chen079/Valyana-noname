...
export default {
	...
	t: {
		name: "幻梦",
		info: `锁定技，当你不因${get.poptip("vl_fox_hm")}使用有目标的基本牌或普通锦囊牌结算完毕后，若此牌非转化且对应的实体牌数为1，你将此牌置于你的武将牌上，称为“幻”；结束阶段，若你有“幻”，你依次对所有“幻”的原目标使用这些“幻”，并弃置无法使用的“幻”。`,
        taici: ['狐火映面，真伪难分。', '幻梦成笼，谁还认得归途？'],
    },
};
