...
export const dynamicTranslate = {
	...
	vl_azao_huxi: function (player) {
		...
		return '锁定技，游戏开始时，你可以令一名其他角色获得“契者”标记。当“契者”或你将受到伤害时，你可以防止此伤害并移除标记，然后你流失1点体力并观看牌堆顶X张牌，将其中一张' + text + '，称之为“护”（X为你发动此技能的次数且至少为1）。然后，你可以令一名其他角色获得“契者”标记。当“契者”回复体力后，你回复等量体力。';
	},
};
